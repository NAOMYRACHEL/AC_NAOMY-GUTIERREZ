...
xt
	y(t) = ( xt0 * t ) * (h)  #hacemos una funcion de operaciondes para ocuparla posteriormente.
	(xt0)= xt0 + h 
	xt0=t(xt0)
	println(EDO) # se imprimen los resultados
end
...
#tenemos que establecer una condicion inicial.
	    x[1] = xt0
	#el problema nos pide condiciones para i. por lo cual lo tenemos que colectar para que cumpe con las igualdades.
