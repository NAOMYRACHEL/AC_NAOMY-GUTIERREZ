...
Pues creo que se refiere  la esquina derecha y da la opcion de opcion de la informacion, en las demas imagenes no sale, debido a como se coloca la imagen.
...
Puede ser que julia vea a las imagenes como conjuntos de vectores que tienen un patron de color.
...
# ╔═╡ 9a086252-760b-4b00-964c-9ed0285331e8
md"""Al usar los slider vemos que el rango de las columnas para delimitar la nariz del gato es del 239 al 296, diferencia de 57 y en el rango de renglones va de 226 a 265, diferencia de 39. 

multiplicando 300 por 451 que nos dice lo del michi da 1353000.0
y a qui para saber de la nariz es 57 por 39 es 2223.0, si rango es igual a la diferencia entonces ya tenemos la respues: 
...
# ╔═╡ 132d4f88-1807-4850-875c-631b460f8fe4
rte_pixeles_blanco= [RGB(1, 1, 1)  RGB(1, 1, 1) RGB(1, 1, 1)  RGB(1, 1, 1) RGB(1, 1, 1)  RGB(1, 1, 1) RGB(1, 1, 1)  RGB(1, 1, 1)
               RGB(1, 1, 1)  RGB(1, 1, 1) RGB(1, 1, 1)  RGB(1, 1, 1) RGB(1, 1, 1)  RGB(1, 1, 1) RGB(1, 1, 1)  RGB(1, 1, 1)
               RGB(1, 1, 1)  RGB(1, 1, 1) RGB(1, 1, 1)  RGB(1, 1, 1) RGB(1, 1, 1)  RGB(1, 1, 1) RGB(1, 1, 1)  RGB(1, 1, 1)
	           RGB(1, 1, 1)  RGB(1, 1, 1) RGB(1, 1, 1)  RGB(1, 1, 1) RGB(1, 1, 1)  RGB(1, 1, 1) RGB(1, 1, 1)  RGB(1, 1, 1)
	           RGB(1, 1, 1)  RGB(1, 1, 1) RGB(1, 1, 1)  RGB(1, 1, 1) RGB(1, 1, 1)  RGB(1, 1, 1) RGB(1, 1, 1)  RGB(1, 1, 1)
               RGB(1, 1, 1)  RGB(1, 1, 1) RGB(1, 1, 1)  RGB(1, 1, 1) RGB(1, 1, 1)  RGB(1, 1, 1) RGB(1, 1, 1)  RGB(1, 1, 1)
...
# ╔═╡ 76800e6a-2e10-4eb2-ba92-967557182c96
rte_pixeles= 
	[RGB(0, 0, 1)  RGB(0, 0, 1) RGB(0, 0, 1)  RGB(0, 0, 1) RGB(0, 0, 1)  RGB(0, 0, 1) RGB(0, 0, 1)  RGB(0, 0, 1) 
	
    RGB(0, 0, 1)  RGB(0, 0, 1) RGB(0, 0.6, 0)  RGB(0, 0.6, 0) RGB(0, 0.6, 0)  RGB(0, 0.4, 0) RGB(0, 0, 1)  RGB(0, 0, 1) 
	
    RGB(1, 0.9, 0.2)  RGB(0, 0.6, 0) RGB(1, 0.9, 0.2)  RGB(0, 0.6, 0) RGB(0, 0.6, 0)  RGB(0, 0.6, 0) RGB(0, 0.4, 0)  RGB(0, 0, 1) 
	
    RGB(0, 0, 1)  RGB(1, 0.9, 0.2) RGB(0, 0.6, 0)  RGB(0, 0.6, 0) RGB(0, 0.6, 0)  RGB(0, 0.6, 0) RGB(0, 0.4, 0) RGB(0, 0, 1) 
	
	RGB(1, 0.9, 0.2) RGB(0,0.6,0) RGB(1, 0.9, 0.2)  RGB(0,0.6,0) RGB(0,0.6,0)  RGB(0,0.6,0) RGB(0,0.4,0)  RGB(0,0,1) 
	
    RGB(0, 0, 1)  RGB(0, 0.6, 0)  RGB(0,0.6,0) RGB(0,0.6,0) RGB(0,0.6,0)  RGB(1, 0.9, 0.2) RGB(0, 0.4, 0)  RGB(1, 0.9, 0.2) 
	
    RGB(0, 0, 1)  RGB(0, 0.6, 0) RGB(0, 0.6, 0)  RGB(0, 0.6, 0)  RGB(0, 0.6, 0)  RGB(0, 0.6, 0) RGB(1, 0.9, 0.2)  RGB(0, 0, 1) 
	
	RGB(0, 0, 1)  RGB(0, 0, 1) RGB(0.8, 0.5, 0.1)  RGB(0.8, 0.5, 0.1) RGB(0.8, 0.5, 0.1)   RGB(1, 0.9, 0.2) RGB(0,0,1)  RGB(1, 0.9, 0.2) 
		 
]


# ╔═╡ 34692bdc-4b29-4eae-b9bc-82d407bf0b27
